...
#matching x an coordinates to use in drawing a grid
...
#filter out openings to the list of whole of obstacles
random_position = list(set(list(filter(lambda a: a not in openinings, all_obs))))
